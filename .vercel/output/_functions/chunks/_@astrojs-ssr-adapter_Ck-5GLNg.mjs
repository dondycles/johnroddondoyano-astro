import { R as ROUTE_TYPE_HEADER, p as REROUTE_DIRECTIVE_HEADER, D as DEFAULT_404_COMPONENT, A as AstroError, q as ActionNotFoundError, v as s, w as clientAddressSymbol, x as LocalsNotAnObject, y as FailedToFindPageMapSSR, z as REROUTABLE_STATUS_CODES, B as responseSentSymbol, C as nodeRequestAbortControllerCleanupSymbol, G as getAugmentedNamespace, H as commonjsGlobal } from './astro/server_C3miGVYS.mjs';
import 'clsx';
import { D as DEFAULT_404_ROUTE, e as default404Instance, f as ensure404Route } from './astro-designed-error-pages_0eGwKvAZ.mjs';
...
import { N as NOOP_MIDDLEWARE_FN } from './noop-middleware_nGrP53rC.mjs';
